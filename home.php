    ...
    <div id="body">
        ...
        <div class="container">
            ...
            <main class="main-content">
                <div class="hero-section">
                    ...
                    <div class="action-buttons">
                        ...
                        <a href="/pages/activite/" class="btn btn-secondary">
                            ...
                            <div class="carousel-card">
                                ...
                                <div class="carousel-info-overlay">
                                    <div class="carousel-info-content">
                                        ...
                                        <a href="/pages/activite/"><button class="carousel-info-btn">Voir plus</button></a>
                                    </div>
                                </div>
                            </div>
                            <div class="carousel-card">
            ...
            <section class="enigmes-section">
                ...
                <div class="fun-facts">
                    ...
                    <div class="fact-hover" id="hover-0">
                        ...
                        <a href="/pages/activite"><button class="fact-button">En savoir +</button></a>
                    </div>
                    ...
                    <div class="fact-hover" id="hover-1">
                        ...
                        <a href="/pages/activite/details.php?id=14"><button class="fact-button">En savoir +</button></a>
                    </div>
                    ...
                    <div class="fact-hover" id="hover-2">
                        ...
                        <a href="/pages/activite/details.php?id=2"><button class="fact-button">En savoir +</button></a>
                    </div>
                    ...
                    <div class="fact-hover" id="hover-3">
                        ...
                        <a href="/pages/activite/details.php?id=13"><button class="fact-button">En savoir +</button></a>
                    </div>
                </div>
            </section>
            ...
            <section class="partners-section">
                <h1 class="testimonials-title">ILS NOUS FONT CONFIANCE</h1>
