<style>
    ...
    .branch {
        ...
        width: 8px;
        height: 0;
        background: linear-gradient(to bottom, #3a791f, #4e8c2b);
        border-radius: 4px;
    ...
    .leaf.green {
        background: linear-gradient(45deg, #3a791f, #4e8c2b);
    }

    .leaf.purple {
        background: linear-gradient(45deg, #8a2be2, #a259e6);
    }
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        branches.forEach(branch => {
            for (let i = 0; i < leafCount; i++) {
                ...
                const colorClass = Math.random() > 0.5 ? 'green' : 'purple';
                leaf.className = `leaf ${colorClass}`;
