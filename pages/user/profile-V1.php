...
<head>
    ...
    <style>
        ...
        .content-columns {
            ...
            flex-wrap: wrap;
            max-width: 100%;
            /* Allow content columns to take up more width */
            padding: 0 40px;
        ...
        #user-map {
            ...
            width: 100%;
            /* Ensure map takes full width of its column */
        }
        ...
        .map-placeholder {
            ...
            padding: 20px;
            width: 100%;
            /* Ensure placeholder takes full width of its column */
            box-sizing: border-box;
            /* Include padding in the element's total width */
        }
        ...
        .abonnement-container {
            max-width: 100%;
            /* Allow subscription container to take up more width */
            margin: 0 auto;
            padding: 0 40px;
            /* Increased padding for breathing room */
            box-sizing: border-box;
        ...
        .abonnement-card {
            ...
            border: 1px solid #000000;
            max-width: 800px;
            /* Keep card max-width for readability */
            margin: 0 auto;
