...
<head>
    ...
    <title>FlowMedia | Mon Niveau</title>
...
<body>
    ...
    <div class="container">
        <h1>Bienvenue, <span style="color: #9C4DF4; font-weight: bold;"> <?php echo htmlspecialchars($user_fullname); ?> !</span></h1>
        <p>Votre total de points : <span style="font-weight: bold;"><?php echo $total_points; ?></span></p>

        <div class="points-scale">
                <div class="scale-item">
                    <img src="../../assets/images/badges/triangle.svg" alt="triangle" class="scale-badge">
        ...
        <div class="progress-path-container">
            ...
            <div class="badge-milestone badge-pro <?php echo $total_points >= 25 ? 'achieved' : ''; ?>">
                <img src="../../assets/images/badges/triangle.svg" alt="Badge Pro">
            </div>
            ...
            <div class="badge-milestone badge-maitre <?php echo $total_points >= 50 ? 'achieved' : ''; ?>">
                <img src="../../assets/images/badges/medaille.svg" alt="Badge Maître">
            </div>
            ...
            <div class="badge-milestone badge-legende <?php echo $total_points >= 100 ? 'achieved' : ''; ?>">
                <img src="../../assets/images/badges/bouclier.svg" alt="Badge Légende">
            </div>
    ...
    <script>
        ...
        function updatePlayerPosition() {
            ...
            const pathPoints = [
                { x: 80, y: 60 },    // Départ
                { x: 200, y: 80 },   // Première courbe
                { x: 350, y: 140 },  // Badge Pro (25 points)
                { x: 500, y: 200 },  // Milieu
                { x: 300, y: 240 },  // Descente
                { x: 150, y: 280 },  // Badge Maître (50 points)
                { x: 250, y: 320 },  // Remontée
                { x: 400, y: 360 },  // Avant dernière courbe
                { x: 650, y: 420 }   // Badge Légende (100 points)
            ];
