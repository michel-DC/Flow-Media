...
<nav class="navbar">
        ...
        <div class="nav-links">
            ...
            <div class="nav-dropdown">
                <button class="nav-dropbtn"><img src="../../assets/uploads/profiles/<?php echo $user_nav['photo_profil']; ?>" alt="Photo de profil" style="width: 30px; height: 30px; border-radius: 50%; object-fit: cover;"> <i class="fa fa-caret-down"></i></button>
                <div class="nav-dropdown-content">
